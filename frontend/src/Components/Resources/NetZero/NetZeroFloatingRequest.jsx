...
export default function NetZeroFloatingRequest() {
    ...
    <>
      ...
      >
        <button
          ...
          className="bg-[#10b981] hover:bg-[#0d9488] text-white font-extrabold py-6 px-3.5 rounded-r-full shadow-xl flex items-center gap-2 transition-all duration-300 hover:shadow-2xl hover:scale-102 border-l border-t border-b border-white/20"
        >
          <ClipboardList className="w-5 h-5 text-white transform rotate-90" />
          <span className="tracking-wide text-xs uppercase font-sans">Request Service</span>
        </button>
      </div>
