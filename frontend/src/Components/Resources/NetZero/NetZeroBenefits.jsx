...
const NetZeroBenefits = ({ benefitsData }) => {
  const getIcon = (title) => {
    switch (title.toLowerCase()) {
      case "sustainability": return Sparkles;
      case "reputation": return ShieldCheck;
      case "compliance": return Bolt;
      ...
      <div className="container mx-auto">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-slate-800">
            Benefits of <span className="text-[#10b981]">Transition</span>
          </h2>
        </motion.div>
...
export default NetZeroBenefits;
