...
const NetZeroProjects = ({ projectsData, hoveredProject, setHoveredProject }) => {
  return (
          ...
          {Object.keys(projectsData).map((key) => (
            ...
            >
              <img
                ...
                onError={(e) =>
                  (e.target.src = `https://placehold.co/800x500/4a9e8a/ffffff?text=${encodeURIComponent(projectsData[key].title)}`)
                }
              />
              <div
              ...
              <div className="relative z-20 h-full w-full flex flex-col justify-end p-4 sm:p-6 md:p-8 text-white bg-gradient-to-t from-black/55 to-transparent">
                ...
                <div className="transition-all duration-500 ease-in-out max-h-0 opacity-0 group-hover:max-h-96 group-hover:opacity-100">
                  <div className="mt-2 sm:mt-4">
                    ...
                    {projectsData[key].link && (
                      <a
                        href={projectsData[key].link}
                        className="mt-3 inline-block text-[#26ffb7] text-xs font-bold uppercase tracking-widest hover:underline"
                      >
                        View Project →
                      </a>
                    )}
...
export default NetZeroProjects;
