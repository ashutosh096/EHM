...
const WaterbodyRestoration = () => {
  ...
  const factors = [
    {
      ...
      image:
        "https://res.cloudinary.com/dlpluej6w/image/upload/v1759495219/storm_water_pypduf.webp",
    },
    {
      id: "f2",
      name: "Dairy waste",
      image:
        "https://res.cloudinary.com/dlpluej6w/image/upload/v1759495221/dirty_waste_ddepg9.webp",
    },
    {
      id: "f3",
      name: "Encroachment",
      image:
        "https://res.cloudinary.com/dlpluej6w/image/upload/v1759494869/enchroament_thds8y.webp",
    },
    {
      id: "f4",
      name: "Industry waste",
      image:
        "https://res.cloudinary.com/dlpluej6w/image/upload/v1759495220/industry_waste_vqrhjj.webp",
    },
    {
      id: "f5",
      name: "Untreated sewage",
      image:
        "https://res.cloudinary.com/dlpluej6w/image/upload/v1759495218/undertreated_sewage_m5kzx4.webp",
    },
    {
      id: "f6",
      name: "Solid waste dumping",
      image:
        "https://res.cloudinary.com/dlpluej6w/image/upload/v1759495220/solide_waste_z8gxjc.webp",
    },
  ];
  ...
  const caseStudy = {
    ...
    intro:
      "The restoration of Antia Talab in Jhansi, a vital project under the Smart City Mission, aimed at revitalizing a severely degraded waterbody.",
    restorationPoints: [
  ...
  const projectsData = {
    laxmi: {
      ...
      description:
        "Preparation of DPR for Sustainable Management of Laxmi Taal Water Body.",
      details: "Waterbody Area - 33.012 ha",
      image:
        "https://res.cloudinary.com/dlpluej6w/image/upload/v1759503658/laxmi_tal_gslimj.webp",
    },
    csjm: {
      title: "CSJM University Campus",
      description:
        "Design & commissioning of bioremediation Floating islands in the newly developed waterbody inside CSJM university campus.",
      details: "",
      image:
  ...
  const approachData = [
    {
      title: "Solution",
      image:
        "https://res.cloudinary.com/dlpluej6w/image/upload/v1759504270/treated_dvs58w.webp",
      points: [
        "Treated water",
        "Treated water through Nature based solutions",
    ...
    },
    {
      title: "Biodiversity",
      image:
        "https://res.cloudinary.com/dlpluej6w/image/upload/v1759504274/biodiversity_hjuewi.webp",
      points: ["Biodiversity restoration", "Increase in Green cover"],
    },
    {
      title: "Awareness",
      image:
        "https://res.cloudinary.com/dlpluej6w/image/upload/v1759504271/awareness_mdw91a.webp",
      points: ["Awareness", "Show casting to school and college kids"],
    },
    {
      title: "Public Engagement",
      image:
        "https://res.cloudinary.com/dlpluej6w/image/upload/v1759504276/public-engagement_j2xm8v.webp",
        ...
        <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-b from-[#7dbea8] to-[#98d8dc] p-4 md:p-8 overflow-hidden">
          ...
          >
            ...
            <motion.h1 className="relative z-10 text-4xl sm:text-5xl md:text-7xl font-extrabold text-white uppercase tracking-wider">
              <span className="text-[#02ffe6]">Restoration </span>of
              <br /> Waterbody{" "}
              <span className="text-[#02ffe6]">Ecosystem </span>
            </motion.h1>
          </ScrollRevealElements>
          ...
          <div className="absolute bottom-6 md:bottom-10 left-[calc(50%-0.5rem)] md:left-1/2 -translate-x-1/2 animate-bounce">
            <div className="w-8 h-8 md:w-11 md:h-11 border-r-2 border-b-2 md:border-r-4 md:border-b-4 border-emerald-500/80 rotate-45"></div>
          </div>
        </section>
        ...
        <section className="bg-gradient-to-b from-[#dbf1f2] to-[#ededed] py-20 px-4">
          ...
          >
            ...
            <motion.div className="text-[#10b981] my-4 lg:my-0 flex-shrink-0">
              <ChevronsDown
                size={60}
                className="block lg:hidden animate-bounce-vertical"
              />
              <ChevronsRight
                size={80}
                className="hidden lg:block animate-bounce-horizontal"
              />
            </motion.div>
            ...
            <motion.div className="flex flex-col items-center">
              ...
              >
                <img loading="lazy" src="https://res.cloudinary.com/dlpluej6w/image/upload/v1759494835/g_polluten_rzolfa.webp"
                  ...
                  onError={(e) =>
                    (e.target.src =
                      "https://placehold.co/400x300/a0aec0/ffffff?text=Polluted+Water")
                  }
                />
            ...
            <div>
              ...
              >
                <h2 className="text-4xl md:text-5xl font-bold text-slate-800">
                  Benefits of{" "}
                  <span className="text-[#10b981]">Restoration</span>
                </h2>
              </motion.div>
                  ...
                  >
                    ...
                    <div
                      className={`absolute inset-0 z-10 transition-colors duration-300 ${
                        hoveredProject && hoveredProject !== key
                          ? "bg-black/60"
                          : "bg-black/0"
                      }`}
                    />
                  ...
                  {approachData.map((item, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div
                          className={`mt-6 w-64 bg-white p-6 rounded-2xl shadow-lg border border-slate-200 text-center transition-transform duration-300 group-hover:-translate-y-2 group-hover:shadow-2xl`}
                        >
                          <h4 className="font-bold text-lg text-slate-700">
                            {item.title}
                          </h4>
